  ...
  return (
    <header>
      <div className="home-wrapper">
        ...
        <div className="section-header">
          <Link to="/Activity" className="nav-item">Our Activity</Link>
        </div>

        <div className="section-header">
          <Link to="/FuturePlan" className="nav-item">Future Plan</Link>
        </div>

        <div className="section-header">
          <Link to="/OurEvents" className="nav-item">Our Events</Link>
        </div>

        <div className="section-header">
  <Link to="/Gallary" className="nav-item">Gallery</Link>
</div>
